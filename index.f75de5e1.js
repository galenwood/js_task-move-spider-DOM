...
wall.addEventListener("click", (e)=>{
    ...
    const workingWidth = Math.floor(currentCord.width / spiderWidth) * spiderWidth;
    let cursorX = e.clientX - currentCord.left - (currentCord.width - workingWidth) / 2;
    let cursorY = e.clientY - currentCord.top - (currentCord.width - workingWidth) / 2;
